    ...
    <div className="stock-overview-page">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="d-flex gap-2">
          <Link to="/manager/stock/update" className="btn btn-secondary">
      ...
      {(statusCounts.critical > 0 || statusCounts.out > 0) && (
        <div className="alert alert-danger mb-4">
          <div className="d-flex align-items-center">
            ...
            <Link to="/manager/stock/predictions" className="btn btn-outline-danger">
              AI Önerilerini Gör
            </Link>
          </div>
        </div>
          ...
          <div className="dashboard-card">
            ...
            <div className="card-body">
              <div className="d-grid gap-2">
                <Link to="/manager/stock/update" className="btn btn-outline-main">
                  <i className="fas fa-edit me-2"></i>
                  Toplu Stok Güncelle
                </Link>
        ...
        <div className="col-md-6">
          <div className="dashboard-card">
            ...
            <div className="card-body">
              ...
              <Link to="/manager/ai/recommendations" className="btn btn-main btn-sm">
...
export default ManagerStockOverview;