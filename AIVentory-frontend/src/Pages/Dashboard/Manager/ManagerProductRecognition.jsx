...
const ManagerProductRecognition = () => {
                ...
                <>
                  ...
                  <div className="text-center mt-3">
                    <button 
                      ...
                      onClick={() => navigate('/manager/analysis-history')}
                    >
          ...
          <div className="dashboard-card mb-4 p-3">
            ...
            <div className="card-body">
              ...
              <button 
                ...
                onClick={() => navigate('/manager/ai/colors')}
              >
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <div className="feature-card text-center p-3" style={{ backgroundColor: 'var(--light-bg)', borderRadius: 'var(--border-radius-sm)' }}>
                      ...
                      <button 
                        className="btn btn-sm btn-outline-main mt-2 w-100"
                        onClick={() => navigate('/manager/color-analysis')}
                      >
                        Başlat
                      </button>
                    </div>
...
export default ManagerProductRecognition;