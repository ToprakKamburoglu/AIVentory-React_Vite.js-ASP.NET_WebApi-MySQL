  ...
  return (
    <div className="employee-dashboard">
      ...
      <div className="quick-actions">
        ...
        <Link to="/manager/stock/update" className="quick-action-btn">
          <div className="quick-action-icon">
        ...
        <Link to="/manager/profile" className="quick-action-btn">
          <div className="quick-action-icon">
            ...
            <div className="card-body" style={{ padding: '24px' }}>
              {dashboardData.recentProducts.length > 0 ? (
                ...
                <div className="empty-state text-center py-5">
                  ...
                  <Link to="/manager/products/add" className="btn btn-primary btn-sm px-4">
              ...
              {dashboardData.recentProducts.length > 0 && (
                <div className="text-center mt-4">
                  <Link to="/manager/products" className="btn btn-outline-primary btn-sm px-4">
        ...
        <div className="col-lg-6 col-md-6 mb-4" style={{ paddingLeft: '12px', paddingRight: '12px' }}>
          <div className="dashboard-card shadow-lg border-0" style={{ height: '100%', borderRadius: '15px', overflow: 'hidden' }}>
            ...
            <div className="card-body" style={{ padding: '24px' }}>
              ...
              {dashboardData.stockAlerts.length > 0 && (
                <div className="text-center mt-4">
                  <Link to="/manager/stock" className="btn btn-outline-warning btn-sm px-4">
